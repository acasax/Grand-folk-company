                        ...
                        <div class="single-page-head">
                            <div class="left-menu">
                                <ul>
                                    ...
                                    <li><a href="mflyttstädning.php">Flyttstädning</a></li>
                                    <li class="active"><a href="mfönsterputs.php">Fönsterputs</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="single-page">
                                ...
                                <p style="margin-top: 15px; text-align: justify">Redskap som vanligen brukar användas är fönsterputsmedel, gummiskrapa.
                                    ...
                                    <br><br><span style="font-weight: bold; margin-top: 15px">Kontakta oss via telefon eller mejl för ett kostnadsfritt möte där vi diskuterar vad ni har för behov och önskemål.</span>
                                </p>
                            </div>
                        </div>
                        <!-- strat single page -->
