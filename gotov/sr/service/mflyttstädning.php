...
<body>
    ...
    ?>
    <!-- Start Bottom Header -->
    <div class="page-area" style="background: url(../img/background/flit.jpg);">
                ...
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="page-head-left">
                        ...
                        <div class="single-page-head">
                            <div class="left-menu">
                                <ul>
                                    <li><a href="mhemstädning.php">Hemstädning</a></li>
                                    <li><a href="mstorstädning.php">Storstädning</a></li>
                                    <li class="active"><a href="mflyttstädning.php">Flyttstädning</a></li>
                                    <li><a href="mfönsterputs.php">Fönsterputs</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="single-page">
                                ...
                                <p style="margin-top: 15px; text-align: justify">Det finns ingen plats som hemma - speciellt när det är rent!
                                    ...
                                    Vår personal är grundlig, professionell och vi erbjuder ett flexibelt schema så att du kan göra allt i tid. Vi är redo att komma och rengöra även de hårdaste orenheterna
                                    Förutom att rengöring vid en flytt kan vara svårt och tröttsamt kräver en flytt en bra organisering och en välutbildad personal. Dessutom är det i grund och botten ett ganska smutsigt jobb.
                                    Efter att ha flyttat ut finns det ett antal påsar, papper, förpackningar, olika skyddsutrustningar eller andra saker som människor helt enkelt lämnar efter sig. En oskriven regel är att lämna
                                    det lediga utrymmet snyggt trots att man flyttar bort och inte i en fullständig röra.Har ni flyttat in någonstans där det är nymålat och rent, bör det vara så även när ni har flyttat ut.
                                    Vi vet om att i all brådska om att flytta ut är städningen ytterligare en distraktion som man tar på sig. Skulle ni behöva städning efter att ni har flyttat, så finns vi här för er.
                                </p><br>
                                <h4>Material</h4>
                                <p>Personalen från Glada folk i Sverigeks har med sig allt material de behöver, så det är inget du behöver tänka på. Det enda vi gärna lånar av er är er dammsugare, av allergiskäl.</p>
                            </div>
                        </div>
                        <!-- strat single page -->
                        <!-- single-well end-->
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="single-well">
                                <a href="#">
                                    <h3>FLYTTSTÄDNING INNEFATTAR</h3>
                                    <p>Detta ingår i vår flyttstädning</p>
                                </a>
                            </div>
                        </div>
                    </div>
