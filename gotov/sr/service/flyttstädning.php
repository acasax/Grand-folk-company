                ...
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="page-head-left">
                        ...
                        <div class="single-page-head">
                            <div class="left-menu">
                                <ul>
                                    <li><a href="hemstädning.php">Hemstädning</a></li>
                                    <li><a href="storstädning.php">Storstädning</a></li>
                                    <li class="active"><a href="flyttstädning.php">Flyttstädning</a></li>
                                    <li><a href="fönsterputs.php">Fönsterputs</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
