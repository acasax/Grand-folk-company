                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="breadcrumb animate__delay-2s animate__animated animate__zoomIn animate__slower">
                            ...
                            <ul>
                                <li class="home-bread">För företag</li>
                ...
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="page-head-left">
                        ...
                        <div class="single-page-head">
                            <div class="left-menu">
                                <ul>
                                    <li><a href="fastighetsskötsel.php">Fastighetsskötsel</a></li>
                                    <li class="active"><a href="kontorsstädning.php">Kontorsstädning</a></li>
                                    <li><a href="ffönsterputs.php">Fönsterputs</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="single-page">
                                ...
                                <p style="margin-top: 15px; text-align: justify">Vi på <span style="font-weight: bold">Glada folk i Sverige</span> erbjuder professionell kontorsstädning av hög kvalité till små och
                                    ...
                                    Vi tar hand om den allmänna hygienen i era kontor, lager, försäljningslokaler, skolor, idrottsanläggningar och andra anläggningar. Vi garanterar en hög sanitär städning för ert affärsområde och era kontor.
                                    Kontorsstädning behövs både för att visa upp presentabla
                                    ...
                                    <br><br><span style="font-weight: bold; margin-top: 15px">Kontakta oss via telefon eller mejl för ett kostnadsfritt möte där vi diskuterar vad just ert företag har för behov och önskemål.av
                                        kontoret missas fortfarande vissa områden att städas.</span>
                                </p>
                            </div>
                        </div>
                        <!-- strat single page -->
