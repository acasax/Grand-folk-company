...
?>
<!-- Start Bottom Header -->
<div class="page-area" style="background: url(../img/background/dond.jpg);" >
            ...
            <div class="col-md-3 col-sm-4 col-xs-12">
                <div class="page-head-left">
                    ...
                    <div class="single-page-head">
                        <div class="left-menu">
                            <ul>
                                <li><a href="mfastighetsskötsel.php">Fastighetsskötsel</a></li>
                                <li><a href="mkontorsstädning.php">Kontorsstädning</a></li>
                                <li  class="active"><a href="mffönsterputs.php">Fönsterputs</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
