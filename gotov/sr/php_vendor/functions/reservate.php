...
switch ($service){
    case 1:
        if ($space > 0 && $space <= 50){
            $sum = 199;
            $time = 1;
            $user_class->returnJSON("OK","Pris för Hämstädning-tjänsten för " . $space . " m2  är ". $sum ." sek och den beräknade arbetstiden är ". $time ." h", 
    ...
    case 2:
        if ($space > 0 && $space < 50){
            $sum = 1950;
            $time = 2;
            $user_class->returnJSON("OK","Pris för Storstädning-tjänsten för " . $space . " m2  är ". $sum ." sek och den beräknade arbetstiden är ". $time ." h", 
    ...
    case 3:
        if ($space > 0 && $space < 51){
            $sum = 2000;
            $user_class->returnJSON("OK","Pris för Flyttstädning-tjänsten för " . $space . " m2  är ". $sum ." sek ", 
